!(function () {
  ...
  !(function () {
    for (var a = 0; a < n; a++) h.push({ x: 0, y: 0, z: t + 0.8 * Math.random() });
  })(),
    v(),
    (function n() {
      e.clearRect(0, 0, r, d),
            ...
            (n.x < -50 || n.x > r + a || n.y < -50 || n.y > d + a) &&
              ...
              i > 1 &&
                ...
                (e =
                  "h" ==
                  (i > h
                    ? Math.random() < Math.abs(m.x) / (i + h)
                      ? "h"
                      : "v"
                    : Math.random() < Math.abs(m.y) / (i + h)
                    ? "v"
                    : "h")
                    ? m.x > 0
                      ? "l"
              ...
              "z" === e
                ? ((o.z = 0.1), (o.x = Math.random() * r), (o.y = Math.random() * d))
                : "l" === e
        ...
        h.forEach(function (n) {
          ...
          var t = 2 * m.x,
            a = 2 * m.y;
          Math.abs(t) < 0.1 && (t = 0.5), Math.abs(a) < 0.1 && (a = 0.5), e.lineTo(n.x + t, n.y + a), e.stroke();
        }),
